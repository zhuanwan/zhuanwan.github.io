...
.m-header .arrowleft:after,.m-header .arrowleft:before {
...
.m-header .arrowleft:before {
  border-right-color: #3B83FF;
  left: -0.16rem;
}

.m-header .arrowright:after,.m-header .arrowright:before {
  border: 0.14rem solid transparent;
