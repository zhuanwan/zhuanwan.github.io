...
import { moduleMenu, moduleValue } from './moduleIndex.js'

export default {
  name: 'jdXcxIndex',
  components: {
    draggable,
    TempStoreInfo: () => import('./tempModule/StoreInfo.vue'),
    TempBanner: () => import('./tempModule/Banner.vue'),
    TempConcat: () => import('./tempModule/Concat.vue'),
    TempCoupon: () => import('./tempModule/Coupon.vue'),
    TempGroupBooking: () => import('./tempModule/GroupBooking.vue'),
    TempGoodsCom: () => import('./tempModule/GoodsCom.vue'),
    TempGoodsRecommend: () => import('./tempModule/GoodsRecommend.vue'),

    StoreInfo: () => import('./module/StoreInfo.vue'),
    Banner: () => import('./module/Banner.vue'),
    Concat: () => import('./module/Concat.vue'),
    Coupon: () => import('./module/Coupon.vue'),
    GroupBooking: () => import('./module/GroupBooking.vue'),
    GoodsCom: () => import('./module/GoodsCom.vue'),
